      ...
      <li>
        <Row className="item-row">
          ...
          <Col xs={1} 
            className="delete" 
            bsSize="small" 
            onClick={()=>{this.props.menu.deleteOrderItem(this.props.count)}}>
          ...
          <Col xs={1} >
            <Row>
              <Glyphicon className="icon" 
                data-test="add-one" 
                onClick={()=>this.props.menu.addOrderQuantity(this.props.count)} 
                glyph="chevron-up" />
            </Row>
            <Row>
              <Glyphicon className="icon" 
                onClick={()=>this.props.menu.subtractOrderQuantity(this.props.count)} 
                glyph="chevron-down" />
            </Row>
          </Col>
        </Row>
